...
const config: Config = {
  ...
  url: 'https://liplum-dev.github.io',
  ...
  organizationName: 'liplum-dev', // Usually your GitHub org/user name.
  projectName: 'tech-stack', // Usually your repo name.
  trailingSlash: false,
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/liplum-dev/tech-stack',
          label: 'GitHub',
          position: 'right',
        },
      ],
